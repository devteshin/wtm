...
from .db import (
    check_user, select_task, select_tasks, change_password, select_stocks, select_operations, select_operations_meta, select_operation, select_arrival, select_max_tare_id, 
    ...
    select_materials_meta, select_materials_data, select_selection_data,
